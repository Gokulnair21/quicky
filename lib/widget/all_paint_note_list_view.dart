...
class AllPaintNoteListTile extends StatefulWidget {
  final Key key;
...
class _AllTextNoteListTileState extends State<AllPaintNoteListTile> {
  final Document document;
  final int index;
